...
if($_POST){
	...
	$sql = "UPDATE penghasilan SET id_kategori='".$_POST['id_kategori']."', tanggal='".$_POST['tanggal']."', judul='".$_POST['judul']."', isi='".$_POST['isi']."', status='".$_POST['status']."' WHERE no=".$_POST['no'];
	...
	$query = $koneksi->query("SELECT * FROM penghasilan WHERE no=".$_GET['no']);
